...
function content_5c1d9caed523d9_62770859 ($_smarty_tpl) {
?>
<!-- 
	# 企业详情编辑
	# Bowen
...
?>
																<input type="hidden" name="office" class="selectVal" value="0" autocomplete="off" data-type="1">
															</ul>
														</div>
													</div>
													<div class="form">
											...
											<div class="retrievalsInputBoxs retrievalsInputBoxsStar clearfix pull-left">
												<div class="retrievalsInputContent">
													<div class="retrievalsInput">
														...
														<input name="phone" type="text" placeholder="请输入部门联系电话" value="<?php echo $_smarty_tpl->tpl_vars['i']->value['phone'];?>
" class="choseInputName" data-type='0' />
													</div>
												</div>
											</div>
