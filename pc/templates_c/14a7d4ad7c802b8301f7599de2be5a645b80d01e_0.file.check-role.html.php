<?php
/* Smarty version 3.1.29, created on 2018-12-17 09:08:31
  from "F:\website\ditoaCoder\ditoa\pc\system\view\check-role.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5c16f70f15c490_13958116',
  'file_dependency' => 
  array (
...
function content_5c16f70f15c490_13958116 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="system/view/css/check-role.css" />
	</head>
			...
			<div class="contentRight col-lg-10 row">
				...
				<div class="contentRightNav clearfix">
					<div class="contentRightNavLeft pull-left">
						<div class="contentRightNavTop"><span><a href="index.php?_f=index">首页</a></span>&nbsp;&nbsp;/&nbsp;&nbsp;<span class="on">审批角色设置</span></div>
						<div class="contentRightNavBottom"><span class="name">审批角色设置</span><span class="time"></span></div>
					</div>
				</div>
				<!--内容区导航end-->
				<!--内容区begin-->
				<div class="contentRightBox">
					<div class="contentRightContent">
						...
						<form id="searchForm" name="searchForm" method="get">
							<input type="hidden" name="_f" value="check-role">
...
" placeholder="请填写角色名称" /></div>
						...
						<div class="downloadAddButtonBox clearfix">
							<a href="?_f=check-role-set&act=add"><div class="downloadAddButton downloadAddButtonL pull-left">新增</div></a>
							<!-- <a href="">
...
?>
									<tr class="backgroundFFF">
										...
										<td width="118" class="paddingLeft40">
											<span><input type="text" id="rank<?php echo $_smarty_tpl->tpl_vars['i']->value['checkRoleId'];?>
...
>
		<?php echo '<script'; ?>
 type="text/javascript" src="system/view/js/check-role.js"><?php echo '</script'; ?>
>
	</body>
