<?php
/* Smarty version 3.1.29, created on 2018-12-22 10:41:14
  from "/Library/WebServer/Documents/Coder/2018/system/ditoa/pc/humanAffairs/view/staff-information.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5c1da44ae0ce47_53560591',
  'file_dependency' => 
  array (
    '11bf7f7bd344efa05ce7a721a7cd7e5f344054ca' => 
    array (
      0 => '/Library/WebServer/Documents/Coder/2018/system/ditoa/pc/humanAffairs/view/staff-information.html',
      1 => 1545446468,
      2 => 'file',
    ),
  ),
...
function content_5c1da44ae0ce47_53560591 ($_smarty_tpl) {
?>
<!-- 
	# 员工基本资料页面
	# Bowen
				...
				<div class="contentRightBox">
					...
					<div class="rightContent">
						<div class="staffManageNav">
							<ul class="clearfix">
								<li class="active">
									<a href="human-affairs.php?_f=staff-information<?php echo $_smarty_tpl->tpl_vars['track']->value;?>
">员工基本资料</a>
								</li>
								<?php if ($_smarty_tpl->tpl_vars['id']->value != 0) {?>
								<li>
									<a href="human-affairs.php?_f=staff-entry<?php echo $_smarty_tpl->tpl_vars['track']->value;?>
">入职信息</a>
								</li>
								<li>
									<a href="human-affairs.php?_f=staff-family<?php echo $_smarty_tpl->tpl_vars['track']->value;?>
">家庭主要成员</a>
								</li>
								<li class="width12">
									<a href="human-affairs.php?_f=staff-education<?php echo $_smarty_tpl->tpl_vars['track']->value;?>
">教育与工作经历</a>
								</li>
								<li>
									<a href="human-affairs.php?_f=staff-welfare<?php echo $_smarty_tpl->tpl_vars['track']->value;?>
">社保与公积金</a>
								</li>
								<li>
									<a href="human-affairs.php?_f=staff-file<?php echo $_smarty_tpl->tpl_vars['track']->value;?>
">资料上传</a>
								</li>
								<li>
									<a href="human-affairs.php?_f=staff-quit<?php echo $_smarty_tpl->tpl_vars['track']->value;?>
">离职信息</a>
								</li>
								<?php if ($_smarty_tpl->tpl_vars['otherPower']->value[1] == 1) {?>
								<li>
									<a href="human-affairs.php?_f=staff-contract<?php echo $_smarty_tpl->tpl_vars['track']->value;?>
">合同信息</a>
								</li>
								<?php }?> <?php if ($_smarty_tpl->tpl_vars['otherPower']->value[2] == 1) {?>
								<li>
									<a href="human-affairs.php?_f=staff-account<?php echo $_smarty_tpl->tpl_vars['track']->value;?>
">账号设置</a>
								</li>
								<?php }?> <?php if ($_smarty_tpl->tpl_vars['otherPower']->value[3] == 1) {?>
								<li>
									<a href="human-affairs.php?_f=staff-leave<?php echo $_smarty_tpl->tpl_vars['track']->value;?>
">假期设置</a>
								</li>
								<?php }?> <?php if ($_smarty_tpl->tpl_vars['otherPower']->value[4] == 1) {?>
								<li>
									<a href="human-affairs.php?_f=staff-edit-log<?php echo $_smarty_tpl->tpl_vars['track']->value;?>
">编辑记录</a>
								</li>
								<?php }?> <?php }?>
							</ul>
									...
									<div class="formBox formLeft">
										<div class="formList">
											<div class="form mbottom57">
												...
												<div class="formInput formSelect"><?php echo $_smarty_tpl->tpl_vars['select']->value['company'];?>
</div>
...
" placeholder="时" class="formInput lunarHourForm width147" autocomplete="off" />
												<input type="text" name="lunarMinute" value="<?php echo $_smarty_tpl->tpl_vars['i']->value['lunarMinute'];?>
" placeholder="分" class="formInput lunarMinuteForm width147 marginL6" autocomplete="off" />
											</div>
											<div class="form">
...
>
			...
			function html5Reader(file, pic, addImg, deleteImg) {
				...
				reader.onload = function(e) {
					...
					$('.uploadPhotoUrl').val(this.result);
				}
				addImg.hide();
				deleteImg.show();
			}
