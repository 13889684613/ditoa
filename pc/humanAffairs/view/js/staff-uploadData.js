...
$(function(){
    ...
    //添加更多文件
    $('.add').click(function(){
        var html = '<div class="uploadBox uploadOtherBox clearfix"><input type="text"placeholder="请输入证件名称"class="setUploadFileTitle"autocomplete="off"/><div class="uploadBtnBox"><input type="file"class="inputFile noMust"name="attachFile"/><img src="../../public/html/images/upload_file_icon.png"alt=""/><p class="uploadBtnTxt">上传文件</p></div><div class="remove"><img src="../../public/html/images/input_remove.png"alt=""></div><div class="showFileName">已选择：<span></span></div></div>'
